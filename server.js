...
app.post("/create_employee", function (req, res) {
	...
	var data = 
		...
		//REQ.BODY.USER._______ is the location of our data being inputted within the form. 

		var config = {
			method: 'post',
			url: 'https://spa-lab-67d93-default-rtdb.firebaseio.com/data.json',
			headers: { 
...
app.get("/directory", function (req, res) {
	...
	var config = {
	method: 'get',
		url: 'https://spa-lab-67d93-default-rtdb.firebaseio.com/.json',
	headers: { }
	};
...
app.get("/directory/:uid", function (req, res) {
	...
	var config = {
		method: 'get',
		url: `https://spa-lab-67d93-default-rtdb.firebaseio.com/data/${id}.json`,
		headers: { }
	};
	...
	axios(config)
		...
		.then((response) => {
			res.render("pages/update", {
				...
				picture: res.body.user.picture,
				title: res.body.user.title,
			});
		})
		.catch(function (error) {
			console.log(error);
